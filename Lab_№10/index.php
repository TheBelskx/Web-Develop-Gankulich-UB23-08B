...
<main>
    ...
    <section id="banner-section">
        <div class="container">
            <div class="banner">
                <h2 class="banner__header">TheBelskx - C++ и Unreal Engine разработчик</h2>
                ...
                <div class="banner-features">
                    ...
                    <span class="banner-features__text"><strong class="banner-features__text_strong">5+</strong>Проектов на C++</span>
                </div>
            </div>
        </div>
